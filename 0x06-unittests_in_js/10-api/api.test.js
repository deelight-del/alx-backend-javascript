...
describe('Testing our application', function () {
  ...
  describe.skip('testing for the login route', function () {
    it('If we login with betty, we should get a betty response', function (done) {
      request({
        method: 'POST',
  ...
  describe('testing for the available_payments route', function () {
    it('deep equal with the object return should be true', function (done) {
